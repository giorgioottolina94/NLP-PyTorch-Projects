...
#with open('../bert/bert_mohx.pickle', 'rb') as handle:
  #bert_mohx = pickle.load(handle)

#bert_mohx = torch.load("../bert/bert_mohx_dict.pth")
...
#                 print("Iteration {}. Training Loss {}.".format(num_iter, avg_eval_loss))
    ...
    torch.save(RNNseq_model, 'mohx_model_{}.pth'.format(i))
